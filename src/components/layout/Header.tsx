                  ...
                  <div className="absolute right-0 mt-2 w-72 bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden z-50">
                    ...
                    <div className="p-3 space-y-1">
                      ...
                      <button
                        ...
                        className="w-full text-left px-3 py-2 text-navy hover:bg-cream rounded-xl transition-colors font-medium text-sm"
                      >
                        👤 Mon espace
                      </button>
              ...
              {user ? (
                <div className="space-y-3">
                  ...
                  <button
                    ...
                    className="block w-full text-center text-navy px-6 py-3 rounded-full font-semibold hover:bg-cream transition-all"
                  >
                    👤 Mon espace
                  </button>
