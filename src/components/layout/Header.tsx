...
const Header = () => {
  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center">
          ...
          <a href="/" className="flex items-center gap-3 group">
            {/* Conteneur du logo avec effet premium */}
            ...
            {/* Texte du logo avec effet premium */}
          ...
          {/* Navigation Desktop - Design Premium */}
          ...
          {/* CTA Button Desktop - Design Premium */}
          ...
          {/* Mobile Menu Button - Style Premium */}
          <button
      ...
      {/* Mobile Navigation - Design Premium */}
        ...
        <div className="bg-white/98 backdrop-blur-md border-t border-gold/10 shadow-premium">
          <div className="max-w-7xl mx-auto px-4 py-6 space-y-4">
            ...
            <div className="pt-4 border-t border-gold/10">
              ...
              <a
                href="/inscription"
                className="block bg-linear-to-r from-turquoise to-turquoise/80 text-white px-6 py-3 rounded-full font-semibold text-center hover:shadow-lg transition-all mt-4"
                onClick={() => setIsMenuOpen(false)}
              >
                Inscription
              </a>
