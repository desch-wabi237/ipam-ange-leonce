...
export const siteConfig = {
  ...
  images: {
    ...
    heroBackground: "/src/assets/images/hero-bg.png",
    placeholders: {
      default: "https://placehold.co/600x400/F8F6F0/D4AF37?text=Image+%C3%A0+venir",
      hero: "https://images.unsplash.com/photo-1523050854058-8df90110c9f1?ixlib=rb-4.0.3&auto=format&fit=crop&w=2070&q=80",
    }
  },
  ...
  hero: {
    ...
    description: "IPAM & Groupe Scolaire Bilingue Ange & Léonce forment les leaders de demain dans un environnement d'excellence, alliant tradition et modernité.",
